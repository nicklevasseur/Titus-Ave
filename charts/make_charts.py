...
.argue p:first-child {{ font-weight:600; }}
...
<div class="page">
  ...
  <div class="argue">
    <p>There is a clear and consistent difference between how the Vice Chair handled 26 Titus Avenue and how he handled every other case in which he can be identified as the speaker. It is not a matter of degree, and it has nothing to do with which way he voted.</p>
    <p>In the other five cases he examines. He works from what is in front of him &mdash; the applicant&rsquo;s own exhibits, the district&rsquo;s stated intent, the City&rsquo;s review sheet, the variance history in the packet. He asks questions capable of changing the answer. He attaches conditions to what he grants. And where he draws on knowledge of his own, he draws on it to test a claim the applicant has made, and says plainly that this is what he is doing.</p>
    <p>At Titus Avenue he stops examining the case and begins making it. The findings stop coming from the record and start coming from him: a buffer no submitted plan describes, a uniqueness measured against his own years on the bench, a property-value conclusion carried by his real estate licence. He asks nothing capable of changing the result, and requires nothing of the applicant in return.</p>
    <p>That shift matters because of where the burden sits. Under RSA 674:33 the applicant must carry all five criteria, and <i>Harrington v. Town of Warner</i> places that burden on the applicant alone. When a member supplies the proof an applicant has conceded it does not have, the burden is not met &mdash; it is relieved. And what a reviewing court later reads as the Board&rsquo;s findings are findings the hearing itself never produced.</p>
  </div>
</div>

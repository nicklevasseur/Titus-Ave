...
<p class="pnum">12. Nor can the defects in those findings be treated as immaterial upon the footing
that four members voted to grant. A vote of four to one would answer the Movants if the record
showed four members weighing these findings independently and arriving at the same place. It shows
something else. It shows one recitation, delivered quickly enough that a member of the Board asked
for a finding to be repeated and did not get it, followed within about a minute and a half by the
motion and the vote. The Movants do not say what any member was thinking, and they do not need to.
They say only what the record shows: that there is but one statement of reasons in this case, that
it is the one the Board adopted, and that no member who voted upon it had it repeated, in writing,
or in discussion before voting.</p>
...
<p class="pnum">13. Member Carnevale asked the applicant directly whether it had obtained a broker
...
<p class="pnum">14. The applicant produced no appraisal, no market study, no comparable sale, and no
...
<p class="pnum">15. Approximately eight minutes after that concession, and in the course of reciting
...
<p class="pnum">16. This was not evidence. Article XIV of this Board&rsquo;s By-Laws provides
...
<p class="pnum">17. The Movants do not suggest that a member must set aside what he knows of the
...
<p class="pnum">18. The statement at issue is of another order. It described no condition of this
...
<p class="pnum">19. The distinction is therefore not one of status but of function. Knowledge of the
...
<p class="pnum">20. The defect is not merely that opinion took the place of evidence. A member
...
<p class="pnum">21. That this was material is established by the record itself. The dissenting
...
<p class="pnum">22. The statement of the district&rsquo;s intent that reached the Board was not the
...
<p class="pnum">23. The findings recited and adopted place the parcel in &ldquo;a transitional
...
<p class="pnum">24. The defect is an absent finding rather than a disputed one. RSA 674:33,
...
<p class="pnum">25. The applicant&rsquo;s entire written showing on this criterion is that
...
benefit, which is the one interest this criterion does not measure. Nor is the loss the applicant does have of the
kind this criterion weighs. On its own plan the parcel yields five conforming lots, so what denial
costs the applicant is the difference between a conforming use and a more profitable one. That is
not a loss to the individual that the public gains nothing by preventing; it is the ordinance
applying as written. <i>Olszak</i>, supra.</p>
...
<p class="pnum">26. The applicant&rsquo;s written memorandum states that the parcel &ldquo;can
...
<p class="pnum">27. At the hearing the applicant told the Board the opposite. Its engineer posed a hypothetical of
...
<p class="pnum">28. No drawing, grading analysis, soils report, or cost estimate was offered in
...
<p class="pnum">29. The Board was asked to disbelieve the applicant&rsquo;s own stamped plan upon
...
<p class="pnum">30. Further, the principal physical feature identified &mdash; slope &mdash; is not a
...
ordinance requires per planned-development unit. The applicant&rsquo;s own By-Right Subdivision Plan
...
<p class="pnum">32. The findings recited and adopted include the following. Each is set against what
the record before the Board actually contained.</p>

<p class="pnum">33. <b>On-street parking.</b> The findings state that the plan &ldquo;reduces the
...
<p class="pnum">34. <b>The enforced buffer.</b> The findings rely upon an &ldquo;enforced
...
<p class="pnum">35. <b>Traffic safety.</b> The Vice Chair stated that &ldquo;by removing curb cuts
...
<p class="pnum">36. These are not incidental remarks. They span three of the five statutory criteria,
...
<p class="pnum">37. In reciting the findings the Vice Chair stated, &ldquo;my overall thought on this
...
<p class="pnum">39. Neither question appears in the statute. RSA 674:33, I(a)(2) enumerates five
criteria, and whether an application is the best available plan for a lot is not among them. Nor is
the comparative question. Unnecessary hardship under RSA 674:33, I(b) asks, in both of its branches,
whether special conditions of the property that distinguish it from other properties in the area
make conformance unreasonable: under I(b)(1), whether &ldquo;no fair and substantial relationship
...
<p class="pnum">40. The substitution was not harmless. Measured against the five-lot subdivision, a
proposal may appear to reduce curb cuts, add buffers, or concentrate development away from a slope,
and the findings recite each of those comparisons. Measured against the statute, the same record
shows a parcel the applicant&rsquo;s own stamped plan proves can be used in conformance with the
ordinance. The comparative frame permitted the Board to find hardship without ever asking whether
conformance was unreasonable, which is the only question I(b) puts to it. That is an error of law,
and it is independent of the sufficiency of the evidence addressed in the grounds above.</p>


<h3>Ground 7. Relief was granted from &sect;8.1.2 without any evidence or finding addressing that
standard.</h3>

<p class="pnum">41. Section 8.1.2 of the Land Use Code governs lot area in a planned development,
...
<p class="pnum">42. The departure is not marginal. The City&rsquo;s Zoning Review states the
...
<p class="pnum">43. What the applicant did offer on density was directed to the standards of the
...
question. RSA 674:33, I(a)(2) authorizes a variance from the terms of the ordinance, and RSA
674:33, I(b)(3) applies the same definition of unnecessary hardship whether the provision from
which relief is sought is &ldquo;a restriction on use, a dimensional or other limitation on a
permitted use, or any other requirement of the ordinance.&rdquo; What the Board cannot do is
substitute another district&rsquo;s standards for those of the district in which the parcel lies.
That is reclassification, and under RSA 675 it is reserved to the local legislative body, in
...
<p class="pnum">44. The motion upon which the Board voted was to &ldquo;grant relief from
...
<p class="pnum">45. The findings recited in support of that motion depend upon mitigation
...
and no condition obliges the applicant to provide, maintain, or refrain from removing a buffer of
any depth. Nor could a condition upon this applicant have secured the buffer principally relied
upon, the 130 to 135 feet of woods lying upon the Mystic Street owners&rsquo; land, which the
applicant&rsquo;s own engineer conceded those owners &ldquo;have the right to develop&hellip; or
expand&hellip; or cut.&rdquo;</p>

<p class="pnum">46. This is distinct from the objection stated in Ground 5. There the point is that
no evidence in the record supported the buffer finding. Here the point is that even if the finding
be taken as made, the relief granted secures nothing that the finding assumes. The Board was not without the means. Article XIII of
its own By-Laws provides that upon a variance it &ldquo;may impose conditions or stipulations that
must be adhered to by the present and subsequent owner(s),&rdquo; and RSA 676:3, I requires a
written decision approving an application with conditions to describe them in detail. Here there
are none to describe. Deferral of concerns to &ldquo;the plan
...
<p class="pnum">47. RSA 676:3, I requires a local land use board to issue a final written decision
...
Article X of this Board&rsquo;s own By-Laws states the same requirement: &ldquo;Notice of the
Board&rsquo;s Decisions will be made available for public inspection within five days. (RSA
676:3).&rdquo;</p>

<p class="pnum">48. <span class="blank">[As of the date of this filing, the City has published no
...
<p class="pnum">49. The consequence is not merely one of delay. The only findings of fact in
existence are those recited orally by one member immediately before the vote, and it is those
findings the grounds above address. Until a written decision issues, neither the Movants nor this
Board can know whether the findings the Board is asked to reconsider are the findings the Board
will ultimately adopt. RSA 677:2 provides for this circumstance. Where the moving party
shows that the minutes and written decision were not filed within five business days after the
vote pursuant to RSA 676:3, II, that party &ldquo;shall have the right to amend the motion for
rehearing, including the grounds therefor, within 30 days after the date on which the written
decision was actually filed.&rdquo; The Movants make that showing here and expressly reserve that
right.</p>
...
<p class="pnum">53. The Movants incorporate by reference the complete case file in ZBA2026-063,
...
Subdivision Plan;</p>
<p class="pnum">D. Address &sect;8.1.2 of the Land Use Code upon evidence, and state the basis for
relief exceeding the lot area that section requires;</p>

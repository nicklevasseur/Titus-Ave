...
_name = "motion_filing.html" if FINAL else "motion.html"
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), _name)

DRAFTING_NOTE = """<p class="small" style="margin-top:22px; color:#444">Highlighted bracketed text marks a blank to be
...
.bucket { font-size:11.6px; margin:16px 0 2px; font-weight:700; font-style:italic;
...
public hearing on September 10, 2026. They are therefore persons entitled to apply for a rehearing under
RSA 677:2, both as abutters as defined by RSA 672:3 and as parties to the action and
proceedings.</p>
...
Code: &sect;4.3-A.1.C (Multifamily Dwellings); &sect;8.1.2 (styled by the City &ldquo;Planned Development Lot Area&rdquo;);
...
Board&rsquo;s operative statement of its reasons, and then the recited findings, which are the only
material in the record capable of supporting the written decision upon the criteria it does not
address.</p>
...
<h3>Ground 1. The written decision contains no finding upon two of the five criteria, and the
record does not supply what it omits, RSA 676:3, I.</h3>

<p class="pnum">14. RSA 676:3, I, as amended effective August 23, 2022, provides that a local land
use board&rsquo;s final written decision &ldquo;shall include specific written findings of fact that
support the decision.&rdquo; The Movants acknowledge that the same paragraph prescribes automatic
reversal only for a disapproval issued without such findings, and prescribes no remedy for an
approval. The requirement itself is stated without qualification, and it attaches to this decision.
A variance may issue only upon affirmative findings on all five criteria of RSA 674:33, I(a)(2), and
this Board&rsquo;s own By-Laws, Article VI, reflect that structure: to obtain a variance &ldquo;an
applicant must make a persuasive showing to each item in five-part criteria.&rdquo;</p>
...
<p class="pnum">17. The Movants are aware of the authority the City will cite. In <i>Kalil v. Town of
Dummer Zoning Board of Adjustment</i>, 155 N.H. 307 (2007), the Court held that &ldquo;the absence
of findings, at least where there is no request therefor, is not in and of itself error.&rdquo; In
<i>Rochester City Council v. Rochester Zoning Board of Adjustment</i>, No. 2017-0501 (N.H. Sept. 7,
2018), where a written decision granting a use variance did not address unnecessary hardship, the
Court examined whether the record supported the decision and found no error, because hardship
&ldquo;was addressed in the variance application, and the ZBA discussed whether the applicant
demonstrated unnecessary hardship.&rdquo;</p>

<p class="pnum">18. Neither case disposes of this one, for two reasons. First, both were decided under
RSA 676:3, I as it stood before August 23, 2022, when the paragraph contained no requirement that
findings support an approval. The sentence now in the statute was added by 2022 N.H. Laws 272:73,
and the Movants have found no reported decision construing it. Second, and more to the point,
<i>Rochester</i> excuses the absence of a written finding only where the record supports the
decision. It does not excuse a finding the record cannot support. The Court there could look past
the written decision because the criterion had been addressed in the application and discussed by
the board. The question here is therefore what the record contains upon the two criteria this
written decision does not address.</p>

<p class="pnum">19. Upon criterion (D), the applicant, asked directly whether it had obtained a broker
price opinion, answered: &ldquo;so no, we did not.&rdquo; Its written memorandum offered on this
criterion only that there is &ldquo;ample buffering&rdquo; and that the project &ldquo;would not
negatively affect surrounding existing properties.&rdquo; The only other material before the Board
was a statement from the bench by the member who recited the findings, addressed in Ground 3. Upon
criterion (C), the applicant&rsquo;s entire written showing was that &ldquo;[t]he benefits to the
applicant in constructing residential which is far more conducive to the property provides
substantial justice,&rdquo; addressed in Ground 5. This is not a record in which, as in
<i>Rochester</i>, the criteria were addressed by the applicant and discussed by the Board. It is a
record in which the applicant disclaimed evidence upon one criterion and weighed only its own
benefit upon the other. A written decision silent upon both, resting upon such a record, is not a
decision supported by specific written findings of fact within the meaning of RSA 676:3, I &mdash;
under the statute as amended or as it stood before.</p>

<p class="pnum">20. To the extent <i>Kalil</i> turns upon whether findings were requested, the
Movants request them now: that any decision upon rehearing state specific written findings of fact
addressed to each of the five criteria of RSA 674:33, I(a)(2), so that the basis of the
Board&rsquo;s decision upon each is stated by the Board rather than inferred from the record by
others.</p>
...
<p class="pnum">21. The motion upon which the Board voted was to &ldquo;grant relief from
...
<p class="pnum">22. The findings recited in support of that motion depend upon mitigation
...
and that &ldquo;a lot of the other problems are addressed in the plan review process.&rdquo; Nothing
in the decision requires any of it. No landscape plan was submitted, no buffer dimension was fixed,
and no condition obliges the applicant to provide or maintain a buffer of any depth. Nor could a
...
<p class="pnum">23. Ground 7 says no evidence supported the buffer finding. The point here is
...
owner(s).&rdquo; It imposed none. Nor does deferral of concerns to &ldquo;the plan review
process&rdquo; answer this. The findings did not rest upon whatever buffer the Planning Board might
later require; they rested upon buffers &ldquo;beyond what the plan development requires in
itself,&rdquo; which by their own terms nothing requires. The criteria of RSA 674:33, I(a)(2) had to
be satisfied upon the record before this Board when it voted, not upon the prospect of later action
...
<p class="pnum">24. The grounds in this and the following two parts address the findings recited at
the hearing. They are stated for two reasons: because, under <i>Rochester</i>, the sufficiency of a
written decision that omits a criterion is tested against the record, and the recited findings are
the only material in the record capable of supporting the written decision upon the criteria it
does not address; and to preserve them under RSA 677:3, I, in the event the Board or a reviewing
court treats the recitation as the operative findings.</p>
...
<p class="pnum">25. Member Carnevale asked the applicant whether it had obtained a broker price
...
<p class="pnum">26. The applicant produced no appraisal, no market study, no comparable sale, and no
...
<p class="pnum">27. Approximately eight minutes after that concession, and in the course of reciting
...
<p class="pnum">28. This was not evidence. Article XIV of this Board&rsquo;s By-Laws provides that
...
<p class="pnum">29. The Movants do not suggest that a member must set aside what he knows of the
...
<p class="pnum">30. The statement at issue is of another order. It described no condition of this
...
<p class="pnum">31. The distinction is therefore not one of status but of function: knowledge of
...
<p class="pnum">32. The defect is not merely that opinion took the place of evidence. A member
...
<p class="pnum">33. The criterion was neither incidental nor conceded. It was put in question by a
member of the Board, answered in the negative by the applicant, and then supplied by the member who
recited the findings and moved the relief. This is the record against which, under
<i>Rochester</i>, the written decision&rsquo;s silence upon criterion (D) must be tested. See
Ground 1.</p>
...
<p class="pnum">34. The statement of the district&rsquo;s intent that reached the Board was not the
...
<p class="pnum">35. The written decision finds the parcel &ldquo;located in a
...
<p class="pnum">36. The defect is an absent finding rather than a disputed one. RSA 674:33, I(a)(2)(A) and (B)
...
<p class="pnum">37. The applicant&rsquo;s entire written showing on this criterion is that
...
<p class="pnum">39. At the hearing the applicant told the Board the opposite. Its engineer posed a hypothetical of
...
<p class="pnum">42. Further, the principal physical feature identified &mdash; slope &mdash; is not a
...
<p class="pnum">44. The findings recited and adopted include the following. Each is set against what
the record before the Board actually contained.</p>

<p class="pnum">45. <b>On-street parking.</b> The written decision finds that the planned
...
<p class="pnum">46. <b>The enforced buffer.</b> The findings rely upon an &ldquo;enforced
...
<p class="pnum">47. <b>Traffic safety.</b> The Vice Chair stated that &ldquo;by removing curb cuts
...
<p class="pnum">48. These are not incidental remarks. They span three of the five statutory criteria,
...
<p class="pnum">49. In reciting the findings the Vice Chair stated, &ldquo;my overall thought on this
...
<p class="pnum">50. Neither question appears in the statute. RSA 674:33, I(a)(2) enumerates five
...
<p class="pnum">51. That the frame was the wrong one was put to the Board before it voted, by a
...
<p class="pnum">52. The substitution was not harmless. Measured against the five-lot subdivision, a
...
<p class="pnum">53. The minimum lot area for a planned development is fixed by &sect;8.7.2.A of the
...
<p class="pnum">54. The departure is not marginal. The City&rsquo;s Zoning Review states the
...
<p class="pnum">55. What the applicant did offer on density was directed to the standards of the
...
<p class="pnum">56. RSA 676:3, II requires that the minutes of the meeting and the written decision be
...
<p class="pnum">57. The Variance Notice of Decision is not minutes. It records none of the particulars
...
<p class="pnum">58. <span class="blank">[State the status of the minutes as of the filing date: whether
...
<p class="pnum">59. The Movants state this ground to preserve it under RSA 677:3, I, and do not
urge it as the principal basis for rehearing.</p>

<p class="pnum">60. In Case No. ZBA2026-078 (26 Sullivan Street), heard the same evening, the Board
...
<p class="pnum">61. In Case No. ZBA2026-080 (374 Thornton Street), also heard the same evening, the
...
<p class="pnum">62. The Movants incorporate by reference the complete case file in ZBA2026-063,
...
HTML = HTML.replace("__DRAFTING_NOTE__", "" if FINAL else DRAFTING_NOTE)
assert "__DRAFTING_NOTE__" not in HTML
open(OUT, "w").write(HTML)
print("wrote", OUT, len(HTML), "bytes", "(FILING COPY)" if FINAL else "(working draft)")

...
<h3>Ground 1. The applicant offered no evidence whatever on RSA 674:33, I(a)(2)(D), and the Board
nonetheless found the criterion satisfied.</h3>

<p class="pnum">9. Member Carnevale asked the applicant directly whether it had obtained a broker
...
<p class="pnum">10. The applicant produced no appraisal, no market study, no comparable sale, and no
opinion of any person qualified to give one. Its written submission on this criterion consists of
two assertions: that there is &ldquo;ample buffering,&rdquo; and that the project &ldquo;would not
negatively affect surrounding existing properties.&rdquo;</p>

<p class="pnum">11. The buffer relied upon is approximately 130 to 135 feet of woods lying upon the
rear yards of the Mystic Street owners, land the applicant does not own. The applicant&rsquo;s own
engineer conceded on the record that those owners &ldquo;have the right to develop that or expand
that or cut that.&rdquo; A buffer upon a neighbor&rsquo;s land, removable at that neighbor&rsquo;s
will, is neither a condition of the subject property nor evidence that values will be preserved.</p>

<p class="pnum">12. The burden on this criterion was the applicant&rsquo;s. <i>Harrington</i>, 152
N.H. at 78. It was not carried. It was not partially carried. On this record there was no evidence
before the Board upon which the finding required by RSA 674:33, I(a)(2)(D) could rest, and the
decision is therefore unlawful and unreasonable.</p>

<h3>Ground 2. The only evidence supporting the property-value finding was supplied from the bench
by a member of the Board.</h3>

<p class="pnum">13. Approximately eight minutes after the applicant conceded it had obtained no
broker opinion, Vice Chair St. Pierre stated, in the course of reciting the findings of fact:</p>
...
<p class="pnum">14. This statement was not evidence. It was not offered under oath, the Movants had
no opportunity to cross-examine it, no opposing opinion could be offered in response, and it rested
upon the member&rsquo;s professional standing and private experience rather than upon anything in
the record. A board&rsquo;s decision must rest upon more than the personal opinion of its members.
<i>Condos East</i>, 132 N.H. at 434.</p>

<p class="pnum">15. The vice of this is not merely that opinion substituted for evidence. It is
that a member supplied the very proof the applicant had conceded, minutes earlier, that it did not
have &mdash; and then voted upon the sufficiency of what he had supplied. The applicant&rsquo;s
burden was not met on this criterion. It was relieved.</p>

<p class="pnum">16. The Movants respectfully submit that the Board should consider whether a member
who furnishes the only evidence on a contested criterion may also sit in judgment upon that
evidence, and should at minimum revisit the finding on RSA 674:33, I(a)(2)(D) upon evidence
properly in the record.</p>
...
<p class="pnum">17. The applicant&rsquo;s written memorandum states that the parcel &ldquo;can
...
<p class="pnum">18. At the hearing the applicant told the Board the opposite. Its engineer asked:
...
<p class="pnum">19. No drawing, grading analysis, soils report, or cost estimate was offered in
...
<p class="pnum">20. The Board was asked to disbelieve the applicant&rsquo;s own stamped plan upon
...
<p class="pnum">21. Further, the only physical feature identified &mdash; slope &mdash; is not a
...
<p class="pnum">22. What the applicant in truth advanced was that a conforming five-lot subdivision
...
<h3>Ground 4. Findings of fact recited in support of the decision are contradicted by testimony
given at the same hearing.</h3>

<p class="pnum">23. The findings state that the plan &ldquo;reduces the need for curb cuts on Calef
Road and preserves existing on street parking.&rdquo; Two witnesses had told the Board there is no
on-street parking on Calef Road to preserve. Kate Markey: &ldquo;Anything south of that,
you&rsquo;ll notice if you drive there, there&rsquo;s big no parking signs.&rdquo; Jennifer Allard:
&ldquo;No one can park on Calef. You&rsquo;re not allowed to park on Calef.&rdquo;</p>

<p class="pnum">24. The findings credit the applicant with the twenty-five foot buffer on the paper
street. Jennifer Allard had testified: &ldquo;I actually got a lawyer and went to court and we won
our half of the street. They didn&rsquo;t give us a half of the street. We won our half.&rdquo;</p>

<p class="pnum">25. The findings recite that the area contains &ldquo;several other mixed or high
density uses including the large development to the south, the cemetery and the Zion School.&rdquo;
A cemetery is not a high density use, and the applicant&rsquo;s own engineer had told the Board of
it that &ldquo;obviously no homes or anything will be built really in that area.&rdquo;</p>

<p class="pnum">26. The findings rely upon an &ldquo;enforced buffer&rdquo; and upon
&ldquo;additional buffers&hellip; beyond what the plan development requires.&rdquo; No landscape
plan or buffer design was submitted with the application. The City&rsquo;s Zoning Review records a
Type 2 buffer as &ldquo;Can comply,&rdquo; which states a possibility and not a proposal.</p>

<p class="pnum">27. Findings that are contradicted by the only testimony on the point, or that rest
upon submissions not in the file, cannot support the decision they were given to justify.</p>
...
<p class="pnum">28. Section 8.1.2 requires 6,000 square feet of lot area per planned-development
unit. Upon 49,484 square feet of buildable area, that standard yields <b>eight units</b>. Thirteen
were granted.</p>

<p class="pnum">29. Neither the applicant nor the Board addressed &sect;8.1.2 on the record. The
...
<p class="pnum">30. The stated intent of the R-1B district under Table 3.3-A of the Land Use Code
...
<p class="pnum">31. The findings describe the area as a &ldquo;transitional area.&rdquo; That is not
...
<p class="pnum">32. Granting a use the district does not permit, in a building type the district
...
<p class="pnum">33. The applicant&rsquo;s entire written showing on this criterion is that
...
<p class="pnum">34. The Movants state this ground to preserve it under RSA 677:3, I, and do not
urge it as the principal basis for rehearing.</p>

<p class="pnum">35. In Case No. ZBA2026-078 (26 Sullivan Street), heard the same evening, the Board
...
<p class="pnum">36. In Case No. ZBA2026-080 (374 Thornton Street), also heard the same evening, the
...
<p class="pnum">37. The Board conditioned its grants that evening in cases far smaller than this
...
<p class="pnum">38. The Movants incorporate by reference the complete case file in ZBA2026-063,
...
<p class="pnum">E. Consider whether a member who supplied the only evidence upon a contested
criterion should participate in the reconsideration of that finding; and</p>
<p class="pnum">F. Grant such further relief as is just.</p>

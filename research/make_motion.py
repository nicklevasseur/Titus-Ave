...
<p class="pnum">23. The defect is an absent finding rather than a disputed one. RSA 674:33,
...
<p class="pnum">37. That the frame was the wrong one was put to the Board before it voted, by a
...
<p class="pnum">38. Neither question appears in the statute. RSA 674:33, I(a)(2) enumerates five
...
<p class="pnum">40. Section 8.1.2 of the Land Use Code governs lot area in a planned development,
...
<p class="pnum">45. This is distinct from the objection stated in Ground 5. There the point is that
...
<p class="pnum">48. The consequence is not merely one of delay. The only findings of fact in

...
<p class="pnum">20. <b>The twenty-five foot buffer and the quieting of title.</b> The findings
recite that &ldquo;the quieting of title on the paper street creates additional buffers to the
properties on the north, whether through the applicant or the other neighbours&rsquo; efforts,&rdquo;
and that &ldquo;there are additional buffers then beyond what the plan development requires in
itself.&rdquo; Jennifer Allard had testified: &ldquo;I actually got a lawyer and went to court and
we won our half of the street. They didn&rsquo;t give us a half of the street. We won our half,
they got the other half. So they didn&rsquo;t give us anything.&rdquo;</p>

<p class="pnum">21. Her testimony is confirmed by the records of this State&rsquo;s courts. On
November 4, 2025 the applicant, T &amp; L 2018, LLC, filed a Complaint to Quiet Title in the
Hillsborough County Superior Court, Northern District, docketed as No. 216-2025-CV-01014. The
defendants are the abutting owners shown on the applicant&rsquo;s own plan sheets &mdash; Tran,
Allard, Hall, Cecenas, the Helen B. Horne 2006 Revocable Trust, the LaRochelles, the Kennedy Family
Revocable Trust of 2014 and Mount Zion Christian Schools &mdash; together with the City of
Manchester. Jennifer Allard, Tracie Cecenas and Rasheed Chinn were obliged to move to intervene to
be heard at all; intervention was granted December 31, 2025. The matter was resolved by a Settlement
Stipulation approved by the Court on February 20, 2026, and the case was closed on March 4, 2026,
some six months before the hearing in this matter.</p>

<p class="pnum">22. The buffer the Board credited was therefore not a concession by the applicant.
It was the outcome of litigation the applicant itself commenced against these abutters, in which
they retained counsel and appeared to defend their own title. A finding that hedges credit for that
buffer toward &ldquo;the applicant or the other neighbours&rsquo; efforts&rdquo; does not describe
what occurred, and the abutter who told the Board so was giving it accurate information that the
Board&rsquo;s findings then set aside.</p>

<p class="pnum">23. <b>The cemetery as a high density use.</b> The findings recite &ldquo;several
...
<p class="pnum">24. <b>The enforced buffer.</b> The findings rely upon an &ldquo;enforced
...
<p class="pnum">25. <b>Uniqueness measured against the member&rsquo;s own experience.</b> The Vice
...
<p class="pnum">28. <b>Slope.</b> The findings recite &ldquo;a lot of slopes, including 18% that
...
<p class="pnum">29. That arithmetic cannot bear the weight the finding placed upon it, for three
...
<p class="pnum">30. <b>Tests the statute does not contain.</b> The Vice Chair stated &ldquo;I do
...
<p class="pnum">31. These are not incidental remarks. They span four of the five statutory criteria,
...
<p class="pnum">38. Section 8.1.2 requires 6,000 square feet of lot area per planned-development
unit. Upon 49,484 square feet of buildable area, that standard yields <b>eight units</b>. Thirteen
were granted.</p>

<p class="pnum">39. Neither the applicant nor the Board addressed &sect;8.1.2 on the record. The
...
<p class="pnum">40. The stated intent of the R-1B district under Table 3.3-A of the Land Use Code
...
<p class="pnum">41. The findings describe the area as a &ldquo;transitional area.&rdquo; That is not
...
<p class="pnum">42. Granting a use the district does not permit, in a building type the district
...
<p class="pnum">43. The applicant&rsquo;s entire written showing on this criterion is that
...
<p class="pnum">44. The Movants state this ground to preserve it under RSA 677:3, I, and do not
urge it as the principal basis for rehearing.</p>

<p class="pnum">45. In Case No. ZBA2026-078 (26 Sullivan Street), heard the same evening, the Board
...
<p class="pnum">46. In Case No. ZBA2026-080 (374 Thornton Street), also heard the same evening, the
...
<p class="pnum">47. The Board conditioned its grants that evening in cases far smaller than this

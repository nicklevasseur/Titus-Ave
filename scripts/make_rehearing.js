...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      N([ r("During deliberations, after the public hearing had been closed, Vice Chair Craig St. Pierre stated technical figures concerning the percentage of slope on the property, specifically "), blank("quote the figures as stated on the recording"), r(". No witness testified to those figures. They do not appear in the applicant's memorandum, the zoning review, or any plan in the file. The Movants do not know their source.") ]),
      N("Slope is the only physical feature of the land that the applicant identified in support of its hardship claim, and the applicant never quantified it. If the Board's finding of unnecessary hardship rests on slope data supplied by a Board member rather than by the applicant, the finding rests on evidence outside the record, and the applicant's burden under RSA 674:33, I(b) was carried by the Board rather than by the applicant."),
      ...
      N("The Movants request that, on rehearing, the Board identify on the record the source of the slope figures stated during deliberation and the basis of the opinion offered on property values, and afford the parties an opportunity to respond to both."),
      ...
      N("Direct that the source of the slope figures and the basis of the property-value opinion be identified on the record;"),

...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      N("Two of the six variances override the district's principal permitted use and its permitted building types. Granting them relocates, by private application, a line the City drew through its legislative process six months earlier. That conflicts with the ordinance's basic zoning objectives unduly and in a marked degree. Chester Rod & Gun Club v. Town of Chester, 152 N.H. 577, 581 (2005); Harborside Assocs. v. Parade Residence Hotel, 162 N.H. 508, 514 (2011)."),

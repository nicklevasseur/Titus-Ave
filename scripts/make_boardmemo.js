...
const headerRow = (label, value) => new TableRow({ children: [
  new TableCell({ width: {size:1400,type:WidthType.DXA}, children:[new Paragraph({children:[new TextRun({text:label,bold:true,size:20})]})]}),
  new TableCell({ width: {size:8200,type:WidthType.DXA}, children:[new Paragraph({children:[new TextRun({text:value,size:20})]})]}),
]});
...
const doc = new Document({
  ...
  sections: [{
    properties: { page: { size: { width: 12240, height: 15840 }, margin: { top: 500, bottom: 500, left: 800, right: 800 } } },
    children: [
      new Paragraph({
        alignment: AlignmentType.CENTER, spacing: { after: 20 },
        children: [ new TextRun({ text: "MEMORANDUM IN OPPOSITION TO VARIANCE APPLICATION", bold: true, size: 28, color: "8B0000" }) ]
      }),
      new Paragraph({
        alignment: AlignmentType.CENTER, spacing: { after: 160 },
        children: [ new TextRun({ text: "Analysis of the Five Statutory Criteria Under RSA 674:33", bold: true, size: 20 }) ]
      }),

      new Table({
        width: { size: 9600, type: WidthType.DXA },
        columnWidths: [1400, 8200],
        borders: { top: {style: BorderStyle.NONE}, bottom: {style: BorderStyle.NONE}, left: {style: BorderStyle.NONE}, right: {style: BorderStyle.NONE},
                   insideHorizontal: {style: BorderStyle.NONE}, insideVertical: {style: BorderStyle.NONE} },
        rows: [
          headerRow("To:", "City of Manchester Zoning Board of Adjustment"),
          headerRow("From:", "Nick Levasseur, 30 Mystic Street, Manchester, NH 03103 (Ward 9); nearby resident and former State Representative, Ward 4"),
          headerRow("Re:", "Case #ZBA2026-063 — 26 Titus Avenue (Map 554, Lot 17C) — Opposition to Requested Variances"),
          headerRow("Date:", "September 9, 2026 (for the public hearing of September 10, 2026)"),
        ]
      }),
      new Paragraph({ text: "", spacing: { after: 160 } }),

      P("The Board may grant this application only if it finds ALL FIVE criteria below satisfied. RSA 674:33, I(a)(2) (listing subparagraphs (A) through (E) conjunctively). The burden of proof on each criterion rests with the applicant. Harrington v. Town of Warner, 152 N.H. 74 (2005). If even one criterion fails, denial is required regardless of the others. This memorandum sets out the controlling statutory text, the governing New Hampshire case law, and the specific facts of record, drawn from the applicant's own submission (“App.”, cited by packet page number), demonstrating that at least three of the five criteria are not met on this record.", { bold: true }),

      P("I want to be clear at the outset that I support more housing in Manchester, and I supported the City's decision this year to rewrite its zoning ordinance to get more of it built. This memorandum does not ask the Board to keep housing out of the city. It asks the Board to respect where the City, six months ago, decided this kind of housing goes."),
      ...
      PRuns([
        reg("The original denial letter and August 3, 2026 hearing notice (App. p. 1) cited "),
      ...
      numbered("§4.3-A.1.C — Multifamily Dwellings (the use itself; zoning review, App. p. 2, lists this as “Not Permitted Per” this section)"),
      numbered("§8.1.2 — Planned Development Lot Area (78,000 SF required; 49,484 SF actual — a 37% shortfall; App. p. 3)"),
      numbered("§5.3.1.E — Townhouse Building Type, Districts Permitted (zoning review, App. p. 3: “N/C — Townhouse Not Allowed”)"),
      numbered("§5.3.1.E.5.B — Maximum Height in Stories (2.5 allowed; 3 proposed; App. p. 3)"),
      numbered("§5.3.1.E.5.C — Maximum Height in Feet (35 ft allowed; 38 ft proposed; App. p. 3)"),
      numbered("§8.7.2.F.2 — Parking Location for Planned Developments (8-unit building’s parking sits within 20 ft of the building; App. p. 4)"),
      ...
      bullet([
        ...
        reg("The Land Use Code assigns townhouse and multifamily building types to specific districts (Tables 4.3-A and 5.3-A). R-1B is not among them, which is why the City's reviewer marked both “Not Permitted” (App. pp. 2–3). The applicant's memo (App. p. 11, criterion 2) argues the R-1B district's “spirit” is to “provide higher density residential neighborhoods.” The district's own name — “Residential One-Family, High Density” (App. p. 2) — specifies one-family housing at higher density. Its spirit is small lots, not multifamily buildings."),
      ]),
      bullet([
        bold("Even the most permissive density rule in the ordinance yields 8 units, not 13. "),
        reg("§8.1.2 requires 6,000 SF of lot area per planned-development unit (App. p. 3: “6,000 x 13 units = 78,000”). At 49,484 SF, this parcel supports 8 units even under the planned-development standard. The applicant seeks 13 — 62% more than the land supports under any provision of the Code."),
      ]),
      bullet([
        bold("The layout depends on planned-development standards the district does not extend to it. "),
        reg("The Zoning Review marks §8.7 Planned Developments “N/C — Not Permitted within the District” (App. p. 6). The site plan nonetheless uses 10-foot side and rear setbacks (App. p. 13), where the base-district standards printed on the applicant's own Zoning Exhibit require 20-foot side and 30-foot rear yards for any “other structure or principal use” (App. p. 14, Note 2). The Board should ask staff to confirm on the record that the six sections above are the complete list of relief this layout requires. A variance granted on an incomplete list is vulnerable to appeal."),
      ]),
      bullet("The denial letter itself (App. p. 1, signed by Michael J. Landry, PE, Esq., Deputy Director of Building Regulations) states directly that the proposal “is prohibited” under these sections and that the Department has “no authority to grant this permit.” That denial predates the plan revision; the six sections above remain live."),
      ...
      H2("The facts"),
      bullet("The applicant's memo (App. p. 11, criterion 3) bases “substantial justice” explicitly on the applicant's own economic benefit: “The benefits to the applicant in constructing residential which is far more conducive to the property provides substantial justice.” Private profit is not a valid basis for this finding (see Criterion 5, Olszak and Governor's Island Club, below)."),
      bullet("There is no real “loss” to weigh in the first place — the applicant's own plans (App. p. 15; see Criterion 5) show a fully conforming 5-lot alternative already exists on this same parcel. Denial costs the applicant nothing but the difference between a permitted project and a preferred one."),
      ...
      bullet("On consistency with the area's present use: within the R-1B district, the residential lots surrounding this parcel — along its 313-foot north line on Mystic Street, on Titus Avenue to the east, and on Calef Road — are single-family homes (App. pp. 9, 13, 14)."),
      ...
      bullet("The only valuation data in the record is the City's assessment card (App. p. 7): the parcel is assessed as vacant residential buildable land, and it sold in July 2024 for $150,000. The applicant's own by-right plan divides it into five building lots (App. p. 15). Nothing in the record suggests the conforming use is uneconomic; the open question under this criterion is the neighbors' values, and on that the record is silent."),
      bullet("The Board is entitled to weigh testimony from nearby owners about the effect on their own properties. Several will speak at the hearing. The applicant has offered nothing to weigh against them."),
      ...
      H2("The facts — the applicant's own By-Right Subdivision Plan (App. p. 15, Sheet 3 of 3, prepared by The Dubay Group, Inc., dated May 21, 2026)"),
      ...
      bullet([
        bold("The admission. "),
        reg("The applicant's own memo (App. p. 11, criterion 3) states outright: “The property can support five (5) single family home lots meeting the underlying zoning.” That is a direct admission, by the applicant's own licensed engineer, that a fully conforming, reasonable use exists without any variance."),
      ]),
      bullet([
        bold("The stated reasons are convenience, not hardship. "),
        reg("(App. p. 11): four of five lots would need separate curb cuts on Calef Road; the site would need grading “built” into the slope for the single-family option; and, again, “the benefits to the applicant.”"),
      ]),
      bullet([
        bold("Branch (A) fails because the applicant identifies no special condition of the land. "),
        reg("The memo's entire answer to (A)(i) (App. p. 12) is that the townhouses “fit well into the neighborhood while providing reasonable density in-kind with the area.” That is a statement about the proposed use and the surrounding neighborhood, not about this land — exactly what Bacon says does not count. The only physical feature the applicant mentions anywhere is slope, and the applicant's own by-right plan places five house lots on that slope. The general purpose of confining R-1B to one-family dwellings is to keep one-family neighborhoods one-family. Applying that provision to a parcel bordered on its longest side by single-family homes is the provision doing precisely its job; the relationship between purpose and application is as fair and substantial as it gets. To the extent the applicant relies on the parcel's “setting” near Laurel Ridge and the school, see Harborside, 162 N.H. at 514 (a property's setting may be a special condition), that setting is the one the City evaluated six months ago when it chose to keep this parcel in R-1B."),
      ]),
      bullet([
        bold("Branch (B) fails on the applicant's own plan. "),
        reg("The property plainly can be reasonably used in strict conformance — the applicant's own engineer drew the plan proving it (App. p. 15)."),
      ]),
      bullet([
        bold("The applicant bought a single-family lot. "),
        reg("T&L 2018, LLC purchased this parcel from the City of Manchester Parks & Recreation Department on July 17, 2024, for $150,000, as vacant residential land in the R-1B district (App. p. 7). Under Hill, that does not bar the application, but the Board may weigh it: the applicant acquired a one-family parcel at a one-family price and now asks the Board to make it something else."),
      ]),
      ...
      bullet("Adopted by the Board of Mayor and Aldermen December 16, 2025; effective March 1, 2026 (App. p. 1). First comprehensive rewrite since 2001; process began 2021."),
      bullet("§4.3-A.1.C and Table 4.3-A — principal uses by district; Multifamily Dwellings not permitted in R-1B (App. p. 2)."),
      bullet("§5.3.1.E and Table 5.3-A — principal building types by district; Townhouse not permitted in R-1B (App. p. 3)."),
      bullet("§5.3.1.E.5.B/C — maximum height, 2.5 stories / 35 ft (App. p. 3)."),
      bullet("§8.1.2 — planned-development lot area, 6,000 SF per unit (App. p. 3)."),
      bullet("§8.7 — Planned Developments; marked “Not Permitted within the District” (App. p. 6). §8.7.2.F.2 — parking location (App. p. 4)."),
      bullet("§8.4 Visibility at Intersections (“No Information”) and §8.5 Site Lighting (“Not Shown”) (App. p. 6)."),

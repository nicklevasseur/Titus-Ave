...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Table({
        ...
        rows: [
          new TableRow({ children: [
            new TableCell({ width: {size:1400,type:WidthType.DXA}, children:[new Paragraph({children:[new TextRun({text:"To:",bold:true,size:20})]})]}),
            new TableCell({ width: {size:8200,type:WidthType.DXA}, children:[new Paragraph({children:[new TextRun({text:"City of Manchester Zoning Board of Adjustment",size:20})]})]}),
          ]}),
          new TableRow({ children: [
            new TableCell({ width: {size:1400,type:WidthType.DXA}, children:[new Paragraph({children:[new TextRun({text:"From:",bold:true,size:20})]})]}),
            new TableCell({ width: {size:8200,type:WidthType.DXA}, children:[new Paragraph({children:[new TextRun({text:"Nick Levasseur, 30 Mystic Street, Manchester, NH 03103 (Ward 9); nearby resident and former State Representative, Ward 4",size:20})]})]}),
          ]}),
          new TableRow({ children: [
            new TableCell({ width: {size:1400,type:WidthType.DXA}, children:[new Paragraph({children:[new TextRun({text:"Re:",bold:true,size:20})]})]}),
            new TableCell({ width: {size:8200,type:WidthType.DXA}, children:[new Paragraph({children:[new TextRun({text:"Case #ZBA2026-063 \u2014 26 Titus Avenue (Map 554, Lot 17C) \u2014 Opposition to Requested Variances",size:20})]})]}),
          ]}),
          new TableRow({ children: [
            new TableCell({ width: {size:1400,type:WidthType.DXA}, children:[new Paragraph({children:[new TextRun({text:"Date:",bold:true,size:20})]})]}),
            new TableCell({ width: {size:8200,type:WidthType.DXA}, children:[new Paragraph({children:[new TextRun({text:"September 10, 2026",size:20})]})]}),
          ]}),
        ]
      }),
      ...
      bullet("The applicant's own memo (App. p. 11, criterion 1, Dubay Group memo to ZBA dated May 20, 2026) offers only that the neighborhood \u201Ccomprises of a mix of various uses\u201D and the project is a \u201Creasonable transition\u201D \u2014 an assertion, not a study. No trip generation, sight distance, or vehicle count data is offered anywhere in the application."),
      bullet("Zoning Review Sheet (App. p. 6, Article 8 table) lists \u201CVisibility at Intersections\u201D as required under \u00A78.4 with the remark \u201CNo Information\u201D \u2014 an unaddressed safety standard at a corner lot."),
      ...
      bullet("There is no real \u201Closs\u201D to weigh in the first place \u2014 the applicant's own plans (App. p. 15; see Criterion 5) show a fully conforming, profitable 5-lot alternative already exists on this same parcel."),
      bullet("The applicant's memo does not address the countervailing public loss: overflow parking onto Titus Ave, Calef Road, and Mystic Street; and added traffic at an unstudied intersection."),
      ...
      bullet("The applicant's own memo (App. p. 11, criterion 3) states outright: \u201CThe property can support five (5) single family home lots meeting the underlying zoning.\u201D A direct admission, by the applicant's own licensed engineer, that a fully conforming, reasonable use exists without any variance."),
      bullet("Their stated reasons for preferring the townhouse version are convenience, not hardship (App. p. 11): four of five lots would need separate curb cuts on Calef Road; the site would need grading \u201Cbuilt\u201D into the slope for the single-family option; and, again, \u201Cthe benefits to the applicant.\u201D"),
      ...
      bullet("The general principle applies here as elsewhere in this line of cases: the hardship inquiry turns on whether a reasonable use exists under the ordinance as written, not on which use would be most advantageous to the owner. Simplex, 145 N.H. 727; Olszak, 139 N.H. at 726."),
